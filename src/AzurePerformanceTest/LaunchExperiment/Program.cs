...
namespace LaunchExperiment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var refExp = new ReferenceExperiment(ExperimentDefinition.Create("z3.zip", ExperimentDefinition.DefaultContainerUri, "reference", "smt2", "model_validate=true -smt2 -file:{0}", TimeSpan.FromSeconds(1200), "Z3", "Sage2", 2048), 20, 16.34375);
