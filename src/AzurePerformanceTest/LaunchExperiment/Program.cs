...
namespace LaunchExperiment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var id = manager.StartExperiment(ExperimentDefinition.Create("z3.zip", ExperimentDefinition.DefaultContainerUri, "", "smt2", "model_validate=true -smt2 -file:{0}", TimeSpan.FromSeconds(1200), "", null, 2048), "Dmitry K", "test").Result;
